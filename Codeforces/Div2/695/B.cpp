...
int main() {
    ...
    F0R(tt,t){
        ...
        ty[0] = ty[n-1] = "-";
        ll ans = 0;
        bool f3 = false, f2 = false;
        FOR(j,1,n-1){
            if(a[j-1] < a[j] && a[j+1] < a[j]) ty[j] = "H";
            else if (a[j-1] > a[j] && a[j+1] > a[j]) ty[j] = "V";
            else ty[j] = "-";
        ...
        FOR(i,1,n-1){
            if(!f3){
                bool c1 = (ty[i-1] == "H" && ty[i] == "V" && ty[i+1] == "H");
                bool c2 = (ty[i-1] == "V" && ty[i] == "H" && ty[i+1] == "V");
            ...
            if(!f2){
                bool c1 = (ty[i-1] == "H" && ty[i] == "V" && ty[i+1] == "H");
                bool c2 = (ty[i-1] == "V" && ty[i] == "H" && ty[i+1] == "V");
                bool c3 = (ty[i-1] == "H" && ty[i] == "V") || (ty[i+1] == "H" && ty[i] == "V");
                bool c4 = (ty[i-1] == "V" && ty[i] == "H") || (ty[i+1] == "V" && ty[i] == "H");
                if(!c1 && !c2 && (c3 || c4)) f2 = true;
            }
